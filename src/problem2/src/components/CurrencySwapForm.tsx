...
const CurrencySwapForm = () => {
  ...
  }, [availableTokens, formData.fromToken, formData.toToken]);
  ...
  return (
    <div className="w-full relative">
      {/* Loading overlay */}
      {isLoading && (
        <div className="absolute inset-0 crypto-card rounded-3xl z-10 flex flex-col items-center justify-center transition-all duration-300 backdrop-blur-xl">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-sm text-black mt-1">Trade tokens in an instant</p>
        </div>
      </div>
